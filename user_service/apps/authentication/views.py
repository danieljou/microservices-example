      ...
      <div class="max-w-4xl w-full">
          ...
          <div class="bg-gradient-to-r from-indigo-600 to-indigo-800 p-8 text-white">
            <div class="flex flex-col md:flex-row items-center justify-between">
              <div class="flex items-center space-x-6 mb-6 md:mb-0">
                ...
                <div>
                  <h1 class="text-3xl font-bold">User Service API</h1>
                  <p class="text-indigo-200">Gestion centralisée des utilisateurs et authentification</p>
                </div>
              </div>
            ...
            <div class="p-6">
              <ul class="space-y-4">
                <li class="flex items-start">
                  ...
                  <div>
                    <h3 class="font-medium text-gray-900">Gestion des utilisateurs</h3>
                    <p class="text-sm text-gray-600">CRUD complet pour les comptes utilisateurs</p>
                  </div>
                </li>
                <li class="flex items-start">
                  <div class="bg-emerald-100 p-2 rounded-full mr-3 mt-1">
                  ...
                  <div>
                    <h3 class="font-medium text-gray-900">Authentification</h3>
                    <p class="text-sm text-gray-600">Token-based avec JWT support</p>
                  </div>
                </li>
                <li class="flex items-start">
                  <div class="bg-emerald-100 p-2 rounded-full mr-3 mt-1">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600">Système de rôles et permissions</p>
                  </div>
                </li>
              </ul>
              ...
              <div class="mt-6 pt-4 border-t border-gray-200">
                <div class="flex items-center justify-between">
                  ...
                  <div class="text-right">
                    ...
                    <p class="font-medium">{datetime.now().strftime('%d/%m/%Y')}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="mt-6 bg-white rounded-xl shadow-md overflow-hidden p-6">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="{reverse('register')}" class="bg-indigo-50 hover:bg-indigo-100 transition-colors p-4 rounded-lg text-center">
              <i class="fas fa-user-plus text-indigo-600 text-2xl mb-2"></i>
              <p class="font-medium">S'inscrire</p>
            </a>
            <a href="{reverse('login')}" class="bg-indigo-50 hover:bg-indigo-100 transition-colors p-4 rounded-lg text-center">
              <i class="fas fa-sign-in-alt text-indigo-600 text-2xl mb-2"></i>
              <p class="font-medium">Se connecter</p>
            </a>
            <a href="{reverse('me')}" class="bg-indigo-50 hover:bg-indigo-100 transition-colors p-4 rounded-lg text-center">
              <i class="fas fa-user-circle text-indigo-600 text-2xl mb-2"></i>
              <p class="font-medium">Profil</p>
            </a>
            <a href="/api/users/" class="bg-indigo-50 hover:bg-indigo-100 transition-colors p-4 rounded-lg text-center">
              <i class="fas fa-list-ul text-indigo-600 text-2xl mb-2"></i>
              <p class="font-medium">Liste utilisateurs</p>
            </a>
          </div>
        </div>
        ...
        <footer class="text-center mt-8 text-sm text-gray-500">
          <p>Microservices Architecture &copy; {current_year}</p>
